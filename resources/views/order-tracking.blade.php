...
<!-- Mirrored from demo.hasthemes.com/zakas-v1/zakas/order-tracking.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Feb 2019 12:25:50 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form class="form form--track" action="#">
                                <div class="form__group mb--30">
                                    ...
                                    <input type="text" name="order_id" name="order_id" class="form__input form__input--2" placeholder="Found in your order confirmation email.">
                                </div>
                                <div class="form__group mb--30">
                                    <label for="billing_email" class="form__label form__label--2">Billing email</label>
                                    <input type="text" name="billing_email" name="billing_email" class="form__input form__input--2" placeholder="Email you used during checkout.">
                                </div>
                                <div class="form__group text-center">
                                    <input type="submit" value="Track Order" class="btn-submit">
                                </div>
                            </form>
                        </div>
                    </div>
