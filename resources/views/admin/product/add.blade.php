			...
			<div class="card-body card-block">
				<form method="POST" role="form" class="form-horizontal">
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-9"><input type="text" id="name_pro" name="name_pro" placeholder="Text" class="form-control" value="">
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-9"><input type="text" id="price_pro" name="price_pro" placeholder="Text" class="form-control" value="">
							<small class="form-text text-muted">
								@if($errors->count() > 0)
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-9"><input type="text" id="sale_price_pro" name="sale_price_pro" placeholder="Text" class="form-control" value="">
						...
						<div class="container col-12 col-md-9">
							<div class="row top">
								<div class="col-12 col-md-9 text-center ">
									...
									<img src="{{url('/')}}/public/admin/assets/img/noimagefound.jpg" alt="" id="prev_img">
									<input type="text" value="" class="form-control" id="none_img" name="img">
								</div>
							</div>
							<small class="form-text text-muted">
								@if($errors->count() > 0)
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-9"><input type="text" id="description" name="description" placeholder="Text" class="form-control" value="">
							<small class="form-text text-muted"></small>
						</div>
					</div>
